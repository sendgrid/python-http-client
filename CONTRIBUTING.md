...
See the [examples folder](https://github.com/sendgrid/python-http-client/tree/HEAD/examples) to get started quickly.
...
An HTTP client with a fluent interface using method chaining and reflection. By returning self on [__getattr__](https://github.com/sendgrid/python-http-client/blob/HEAD/client.py#L74) and [_()](https://github.com/sendgrid/python-http-client/blob/HEAD/client.py#L70), we can dynamically build the URL using method chaining and [__getattr__](https://github.com/sendgrid/python-http-client/blob/HEAD/client.py#L74) allows us to dynamically receive the method calls to achieve reflection.

This allows for the following mapping from a URL to a method chain:

`/api_client/{api_key_id}/version` maps to `client.api_client._(api_key_id).version.<method>()` where <method> is a [HTTP verb](https://github.com/sendgrid/python-http-client/blob/HEAD/client.py#L24).
...
All test files are in the [`tests`](https://github.com/sendgrid/python-http-client/tree/HEAD/tests) directory.

For the purposes of contributing to this repo, please update the [`test_unit.py`](https://github.com/sendgrid/python-http-client/blob/HEAD/test/test_unit.py) file with unit tests as you modify the code.
